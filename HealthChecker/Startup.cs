...
namespace HealthChecker
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IServerStatusService, ServerStatusService>();
            services.AddDbContext<Context>(options => options.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=HealthCheck;Trusted_Connection=True;"));
